...
export const metadata: Metadata = {
  title: "The Zen of remux",
  description:
    "remux is a primitive, not a solution. It gives you composable pieces and your workflow is up to you.",
  keywords: [
    "remux",
    "terminal",
    "macOS",
  ...
  openGraph: {
    ...
    url: absoluteUrl("/blog/zen-of-remux"),
  },
  twitter: {
    card: "summary",
    title: "The Zen of remux",
  ...
  alternates: {
    canonical: absoluteUrl("/blog/zen-of-remux"),
  },
};

export default function ZenOfRemuxPage() {
  return (
    <>
      <div className="mb-8">
        <Link
      ...
      <h1>The Zen of remux</h1>
      <time dateTime="2026-02-27" className="text-sm text-muted">
        February 27, 2026
      </time>

      <p className="mt-6">
        remux is not prescriptive about how developers hold their tools.
        It&apos;s a terminal and browser with a CLI, and the rest is up to you.
      </p>

      <p>
        remux is a primitive, not a solution. It gives you a terminal, a browser,
        notifications, workspaces, splits, tabs, and a CLI to control all of
        it. remux doesn&apos;t force you into an opinionated
