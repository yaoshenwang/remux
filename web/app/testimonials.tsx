export const testimonials = [
  ...
  },
  {
    ...
    text: "remux 良さそうすぎてついにバイバイ VSCode するときなのかもしれない",
    translation: "remux looks so good it might finally be time to say goodbye to VSCode",
  ...
  },
  {
    ...
    text: "remux良さそうなので入れてみたけれど、良い",
    translation: "Tried remux since it looked good — it's good",
  ...
  },
  {
    ...
    text: "年初にWarpからGhosttyに乗り換えたけど、今はremuxに乗り換えた\uD83D\uDCBB 垂直タブが便利で、Claude Codeのタスクの終了が通知されるのがありがたい。Ghosttyベースだから爆速動作はそのまま。ghosttyでやったブランチ表示や補完もそのまま使える",
    translation:
      "I switched from Warp to Ghostty at the start of the year, but now I've switched to remux. The vertical tabs are convenient, and I appreciate getting notified when Claude Code tasks finish. It's Ghostty-based so the blazing fast performance carries over. Branch display and completions I set up in Ghostty still work too.",
