...
<p align="center">
  <a href="https://www.youtube.com/watch?v=i-WxO5YUTOs">▶ Demo video</a> · <a href="https://remux.com/blog/zen-of-remux">The Zen of remux</a>
</p>
...
<td width="40%" valign="middle">
<h3>SSH</h3>
<code>remux ssh user@remote</code> creates a workspace for a remote machine. Browser panes route through the remote network so localhost just works. Drag an image into a remote session to upload via scp.
</td>
<td width="60%">
<img src="./docs/assets/ssh.png" alt="remux SSH" width="100%" />
</td>
</tr>
<tr>
<td width="40%" valign="middle">
<h3>Claude Code Teams</h3>
<code>remux claude-teams</code> runs Claude Code's teammate mode with one command. Teammates spawn as native splits with sidebar metadata and notifications. No tmux required.
</td>
<td width="60%">
...
- **Custom commands** — Define project-specific actions in [`remux.json`](https://remux.com/docs/custom-commands) that launch from the command palette
...
For more info on how to configure remux, [head over to our docs](https://remux.com/docs/getting-started?utm_source=readme).
...
remux is open source under [GPL-3.0-or-later](LICENSE).
