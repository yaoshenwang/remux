...
final class SidebarBranchOrderingTests: XCTestCase {
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                first: pullRequestState(
                    number: 337,
                    label: "PR",
                    url: "https://github.com/yaoshenwang/remux-macos/pull/337",
                    status: .open
                ),
        ...
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            ...
            panelPullRequests: [
                first: pullRequestState(
                    number: 42,
                    label: "PR",
                    url: "https://github.com/yaoshenwang/remux-macos/pull/42",
                    status: .open
                ),
                second: pullRequestState(
                    number: 42,
    ...
    func testOrderedUniquePullRequestsTreatsSameNumberAndLabelDifferentUrlsAsDistinct() {
        ...
        XCTAssertEqual(
            ...
            [
                "https://github.com/yaoshenwang/remux-macos/pull/42",
    ...
    func testUpdatePanelPullRequestPreservesExistingChecksWhenUpdateOmitsThem() {
        ...
        workspace.updatePanelPullRequest(
            ...
            number: 42,
            label: "PR",
            url: URL(string: "https://github.com/yaoshenwang/remux-macos/pull/42")!,
            status: .open,
            checks: .pass
        )
        workspace.updatePanelPullRequest(
    ...
    func testOrderedUniquePullRequestsUsesFallbackWhenNoPanelPullRequestsExist() {
        let fallback = pullRequestState(
            number: 11,
            label: "PR",
            url: "https://github.com/yaoshenwang/remux-macos/pull/11",
            status: .open
        )
        let pullRequests = SidebarBranchOrdering.orderedUniquePullRequests(
            orderedPanelIds: [],
