...
struct WebViewRepresentable: NSViewRepresentable {
        ...
        private func updateHostedInspectorDockControlAvailabilityIfNeeded(reason: String) {
            ...
            hostedInspectorFrontendWebView.evaluateJavaScript(
                ...
                (() => {
                    ...
                    if (!WI.__remuxOriginalUpdateDockNavigationItems && typeof WI._updateDockNavigationItems === "function")
                        WI.__remuxOriginalUpdateDockNavigationItems = WI._updateDockNavigationItems;
                    if (!WI.__remuxOriginalDockLeft && typeof WI._dockLeft === "function")
                        WI.__remuxOriginalDockLeft = WI._dockLeft;
                    if (!WI.__remuxOriginalDockRight && typeof WI._dockRight === "function")
                        WI.__remuxOriginalDockRight = WI._dockRight;
                    if (!WI.__remuxOriginalTogglePreviousDockConfiguration && typeof WI._togglePreviousDockConfiguration === "function")
                        WI.__remuxOriginalTogglePreviousDockConfiguration = WI._togglePreviousDockConfiguration;
                    ...
                    function enforceDockControls() {
                        const disallowSideDock = !WI.__remuxAllowSideDock;
                    ...
                    WI.__remuxAllowSideDock = allowSideDock;
                    WI._dockLeft = function(event) {
                        if (!WI.__remuxAllowSideDock)
                            return callOriginal(WI._dockBottom, event);
                        return callOriginal(WI.__remuxOriginalDockLeft, event);
                    };
                    WI._dockRight = function(event) {
                        if (!WI.__remuxAllowSideDock)
                            return callOriginal(WI._dockBottom, event);
                        return callOriginal(WI.__remuxOriginalDockRight, event);
                    };
                    WI._togglePreviousDockConfiguration = function(event) {
                        ...
                        if (!WI.__remuxAllowSideDock && previousSideDock)
                            return callOriginal(WI._dockBottom, event);
                        return callOriginal(WI.__remuxOriginalTogglePreviousDockConfiguration, event);
                    };
                    WI._updateDockNavigationItems = function(...args) {
                        if (typeof WI.__remuxOriginalUpdateDockNavigationItems === "function")
                            WI.__remuxOriginalUpdateDockNavigationItems.apply(WI, args);
                        enforceDockControls();
                    };
                    WI._updateDockNavigationItems();
                    return WI.__remuxAllowSideDock;
                })();
                """,
    ...
    private static func shouldPreserveExternalFullscreenHost(
        ...
        webView.remuxIsManagedByExternalFullscreenWindow(relativeTo: expectedWindow)
    }
