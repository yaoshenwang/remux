...
extension Notification.Name {
    static let remuxNotificationsPopoverVisibilityDidChange = Notification.Name("remux.notificationsPopoverVisibilityDidChange")
}
...
private func postNotificationsPopoverVisibilityDidChange(isShown: Bool) {
    NotificationCenter.default.post(
        name: .remuxNotificationsPopoverVisibilityDidChange,
        object: nil,
...
struct TitlebarControlsView: View {
    ...
    var body: some View {
        ...
        controlsGroup(config: config)
            ...
            .onReceive(NotificationCenter.default.publisher(for: .remuxNotificationsPopoverVisibilityDidChange)) { notification in
