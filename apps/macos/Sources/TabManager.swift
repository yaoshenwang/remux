...
class TabManager: ObservableObject {
    ...
    init(initialWorkingDirectory: String? = nil, skipInitialWorkspace: Bool = false) {
        if !skipInitialWorkspace {
    ...
    private func maybeMutateSelectionDuringWorkspaceCreationForDev(
        ...
        let isEnabled: Bool = {
            if let raw = env["REMUX_DEV_MUTATE_WORKSPACE_SELECTION_DURING_CREATION"] {
                return raw == "1" || raw.caseInsensitiveCompare("true") == .orderedSame
            }
            return UserDefaults.standard.bool(forKey: "remuxDevMutateWorkspaceSelectionDuringCreation")
        }()
        guard isEnabled,
    ...
    func addWorkspace(
        ...
        remuxKind: Workspace.RemuxWorkspaceKind = .local
    ) -> Workspace {
        ...
        return withExtendedLifetime((capturedTabs, sourceWorkspace)) {
            ...
            newWorkspace.remuxKind = remuxKind
            if title != nil {
    ...
    private func inheritedTerminalConfigForNewWorkspace() -> RemuxSurfaceConfigTemplate? {
...
extension Notification.Name {
    static let commandPaletteToggleRequested = Notification.Name("remux.yaoshen.wangmandPaletteToggleRequested")
    static let commandPaletteRequested = Notification.Name("remux.yaoshen.wangmandPaletteRequested")
    static let commandPaletteSwitcherRequested = Notification.Name("remux.yaoshen.wangmandPaletteSwitcherRequested")
    static let commandPaletteSubmitRequested = Notification.Name("remux.yaoshen.wangmandPaletteSubmitRequested")
    static let commandPaletteDismissRequested = Notification.Name("remux.yaoshen.wangmandPaletteDismissRequested")
    static let commandPaletteRenameTabRequested = Notification.Name("remux.yaoshen.wangmandPaletteRenameTabRequested")
    static let commandPaletteRenameWorkspaceRequested = Notification.Name("remux.yaoshen.wangmandPaletteRenameWorkspaceRequested")
    static let commandPaletteMoveSelection = Notification.Name("remux.yaoshen.wangmandPaletteMoveSelection")
    static let commandPaletteRenameInputInteractionRequested = Notification.Name("remux.yaoshen.wangmandPaletteRenameInputInteractionRequested")
    static let commandPaletteRenameInputDeleteBackwardRequested = Notification.Name("remux.yaoshen.wangmandPaletteRenameInputDeleteBackwardRequested")
    ...
    static let terminalPortalVisibilityDidChange = Notification.Name("remux.terminalPortalVisibilityDidChange")
    static let browserPortalRegistryDidChange = Notification.Name("remux.browserPortalRegistryDidChange")
}
