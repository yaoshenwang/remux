...
extension UNUserNotificationCenter {
    private static let removalQueue = DispatchQueue(
        label: "com.remux.notification-removal",
        qos: .utility
    )
...
enum NotificationSoundSettings {
    ...
    private static let customSoundPreparationQueue = DispatchQueue(
        label: "com.remux.notification-sound-preparation",
        qos: .utility
    )
    ...
    private static let customCommandQueue = DispatchQueue(
        label: "com.remux.notification-custom-command",
        qos: .utility
    )
...
final class TerminalNotificationStore: ObservableObject {
    ...
    static let categoryIdentifier = "com.remux.app.userNotification"
    static let actionShowIdentifier = "com.remux.app.userNotification.show"
