...
LATEST_RELEASE_APPCAST_URL="${REMUX_RELEASE_APPCAST_URL:-https://github.com/yaoshenwang/remux/releases/latest/download/appcast.xml}"
LATEST_RELEASE_BUILD="$(
  { curl -fsSL --max-time 8 "$LATEST_RELEASE_APPCAST_URL" 2>/dev/null || true; } \
