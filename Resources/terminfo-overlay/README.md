# remux terminfo overlay

remux ships Ghostty's `xterm-ghostty` terminfo entry, but the embedded
renderer in remux has differed from Ghostty's app renderer in how it treats
