# Command Reference (remux Markdown)

## Opening a Markdown Panel

```bash
remux markdown open <path>
remux markdown <path>          # shorthand (implicit "open")
```
...
|------|-------------|---------|
| `--workspace <id\|ref\|index>` | Target workspace | `$REMUX_WORKSPACE_ID` |
...
remux markdown open ./plan.md
remux markdown open /Users/me/project/plan.md
```
