...
```bash
remux browser surface:7 snapshot
remux browser surface:7 snapshot --interactive
remux browser surface:7 snapshot --interactive --compact --max-depth 3
```

## Using Refs

```bash
remux browser surface:7 click e6
remux browser surface:7 fill e10 "user@example.com"
remux browser surface:7 fill e11 "password123"
remux browser surface:7 click e12
```
...
remux browser surface:7 click e1
...
```bash
remux browser surface:7 wait --selector "#target" --timeout-ms 10000
remux browser surface:7 scroll --dy 400
remux browser surface:7 snapshot --interactive
```
...
```bash
remux browser surface:7 snapshot --selector "form#checkout" --interactive
```
