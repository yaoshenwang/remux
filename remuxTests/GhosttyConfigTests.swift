...
final class GhosttyConfigTests: XCTestCase {
    ...
    func testReleaseAppSupportFallbackLoadsForDebugWhenOnlyReleaseConfigExists() {
        XCTAssertTrue(
            GhosttyApp.shouldLoadReleaseAppSupportGhosttyConfig(
                currentBundleIdentifier: "com.remuxterm.app.debug",
    ...
    func testReleaseAppSupportFallbackSkipsWhenDebugConfigAlreadyExists() {
        XCTAssertFalse(
            GhosttyApp.shouldLoadReleaseAppSupportGhosttyConfig(
                currentBundleIdentifier: "com.remuxterm.app.debug.issue-829",
                currentConfigFileSize: nil,
    ...
    func testReleaseAppSupportFallbackSkipsForNonDebugBundleOrMissingReleaseConfig() {
        XCTAssertFalse(
            GhosttyApp.shouldLoadReleaseAppSupportGhosttyConfig(
                currentBundleIdentifier: "com.remuxterm.app",
                currentConfigFileSize: nil,
                currentLegacyConfigFileSize: nil,
                releaseConfigFileSize: 128,
                releaseLegacyConfigFileSize: nil
...
final class WindowTransparencyDecisionTests: XCTestCase {
    ...
    func testBehindWindowGlassPathStillControlsTransparentWindowFallback() {
        withTemporaryWindowBackgroundDefaults {
            ...
            XCTAssertEqual(remuxShouldUseTransparentBackgroundWindow(), expectedTransparentFallback)
            XCTAssertEqual(
                remuxShouldUseClearWindowBackground(for: 1.0),
...
final class SocketControlSettingsTests: XCTestCase {
    ...
    func testStableReleaseIgnoresAmbientSocketOverrideByDefault() {
        let path = SocketControlSettings.socketPath(
            ...
            bundleIdentifier: "com.remuxterm.app",
            isDebugBuild: false
        )

        XCTAssertEqual(path, "/tmp/remux.sock")
    }
    ...
    func testNightlyReleaseUsesDedicatedDefaultAndIgnoresAmbientSocketOverride() {
        let path = SocketControlSettings.socketPath(
            ...
            bundleIdentifier: "com.remuxterm.app.nightly",
            isDebugBuild: false
        )
    ...
    func testDebugBundleHonorsSocketOverrideWithoutOptInFlag() {
        let path = SocketControlSettings.socketPath(
            ...
            bundleIdentifier: "com.remuxterm.app.debug.my-tag",
            isDebugBuild: false
        )
    ...
    func testStagingBundleHonorsSocketOverrideWithoutOptInFlag() {
        let path = SocketControlSettings.socketPath(
            ...
            bundleIdentifier: "com.remuxterm.app.staging.my-tag",
            isDebugBuild: false
        )
    ...
    func testDefaultSocketPathByChannel() {
        XCTAssertEqual(
            SocketControlSettings.defaultSocketPath(bundleIdentifier: "com.remuxterm.app", isDebugBuild: false),
            "/tmp/remux.sock"
        )
        XCTAssertEqual(
            SocketControlSettings.defaultSocketPath(bundleIdentifier: "com.remuxterm.app.nightly", isDebugBuild: false),
            "/tmp/remux-nightly.sock"
        )
        XCTAssertEqual(
            SocketControlSettings.defaultSocketPath(bundleIdentifier: "com.remuxterm.app.debug.tag", isDebugBuild: false),
            "/tmp/remux-debug.sock"
        )
        XCTAssertEqual(
            SocketControlSettings.defaultSocketPath(bundleIdentifier: "com.remuxterm.app.staging.tag", isDebugBuild: false),
    ...
    func testUntaggedDebugBundleBlockedWithoutLaunchTag() {
        XCTAssertTrue(
            SocketControlSettings.shouldBlockUntaggedDebugLaunch(
                environment: [:],
                bundleIdentifier: "com.remuxterm.app.debug",
                isDebugBuild: true
            )
        )
    }
    ...
    func testTaggedDebugBundleAllowedWithoutLaunchTag() {
        XCTAssertFalse(
            SocketControlSettings.shouldBlockUntaggedDebugLaunch(
                environment: [:],
                bundleIdentifier: "com.remuxterm.app.debug.tests-v1",
                isDebugBuild: true
            )
        )
    }
...
final class PostHogAnalyticsPropertiesTests: XCTestCase {
    ...
    func testSuperPropertiesIncludePlatformVersionAndBuild() {
        ...
        XCTAssertEqual(properties["platform"] as? String, "remuxterm")
        XCTAssertEqual(properties["app_version"] as? String, "0.31.0")
        XCTAssertEqual(properties["app_build"] as? String, "230")
    }
    ...
    func testPropertiesOmitVersionFieldsWhenUnavailable() {
        ...
        XCTAssertEqual(superProperties["platform"] as? String, "remuxterm")
